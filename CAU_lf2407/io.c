...
unsigned int read_s(void){
	...
	if(moni_data.a_up) temp |= 0x0001;
	if(moni_data.a_down) temp |= 0x0002;
	if(moni_data.a_ovld) temp |= 0x0004;
	if(moni_data.b_up) temp |= 0x0008;
	if(moni_data.b_down) temp |= 0x0010;
	if(moni_data.b_ovld) temp |= 0x0020;
	if(moni_data.c_up) temp |= 0x0040;
	if(moni_data.c_down) temp |= 0x0080;
	if(moni_data.c_ovld) temp |= 0x0100;
	if(0x1234 == moni_data.state_tirg) temp |= 0x0200;//CPLD ok
