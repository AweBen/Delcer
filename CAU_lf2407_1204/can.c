		...
		if(0 == canr[4]){//data frame
			switch(can_id & 0xFFFFFF00){
				...
				case 0x220100://mode set
			     	order_data_new.p_set = (float)canr[0];   //order_data.contrl_word 
					break;
				case 0x220200:
                    order_data_new.i_set = (float)canr[0];   //data_dn_dpram.manual_Ba
					break;
				case 0x220300:
					order_data_new.d_set = (float)canr[0];    //data_dn_dpram.manual_Bb
					break;
				case 0x220400:
					order_data_new.pid_up_set = (float)canr[0];   //data_dn_dpram.manual_Bc
					break;
				case 0x220500:
					order_data_new.pid_down_set = (float)canr[0];
					break;
				case 0x220600:
					order_data_new.phase_value = (float)canr[0];
					break;
				case 0x220700:
					order_data_new.current_value = (float)canr[0];
					break;
				case 0x220800:
					order_data_new.exceed_current_value = (float)canr[0];
					break;
				case 0x220900:
					order_data_new.exceed_DCvoltage_value = (float)canr[0];
					break;
				case 0x220A00:
					order_data_new.time_value = (float)canr[0];
					break;
				case 0x220B00:
					order_data_new.start_stop_control = (float)canr[0];
					break;
			...
			switch(0xFFFFFF00 & can_id){
				...
				case 0x221100://current
					...
					break;
				case 0x221200:
					cans[0] = moni_data.dc_voltage;   // struct member changed
					cans[1] = 0;
					cans[2] = 0;
					cans[3] = 0;
					break;
				case 0x221300:
					cans[0] = moni_data.dc_current;   // struct member changed
					cans[1] = 0;
					cans[2] = 0;
					cans[3] = 0;
					break;
